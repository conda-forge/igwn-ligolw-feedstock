...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/igwn-ligolw-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/igwn-ligolw-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=24661&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/igwn-ligolw-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_python3.14.____cp314t" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
pixi add igwn-ligolw
# for installing globally
pixi global install igwn-ligolw
```
...
It is possible to list all of the versions of `igwn-ligolw` available on your platform:
...
```
pixi search igwn-ligolw --channel conda-forge
```
